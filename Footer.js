            ...
            <div className="footer-lists">
              <ul className="list">
                ...
                <li className="list-body">
                  <Link to="/" className="logo"> {/* Replace the anchor with Link */}
                  ...
                  <p className="mt-3">
                    Copyright {new Date().getFullYear()} &copy; <a className="d-inline text-primary" href="http://www.devcrud.com">DevCRUD</a>
                  </p>
                </li>
              </ul>
              <ul className="list">
